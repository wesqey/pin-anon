...
export function PatternLibrary({ dark, onLoadPattern }) {
...
export function Sandbox({ onBack, dark }) {
...
export function SandboxWindow({ window, dark, isFocused, params, focusedInstrumentType, audioContext, masterGain, analyser, windows, instrumentParams, onDragStart, onClose, onToggleMinimize, onFocus, onParamChange }) {
...
export function PulseWaveMinimal({ dark, params, audioContext, masterGain, windows, instrumentParams, onParamChange }) {
...
export function GridSeqMinimal({ dark, params, audioContext, masterGain, onParamChange }) {
...
export function DragKnob({ label, value, min, max, step, onChange, unit = '', dark }) {
...
export function UnifiedControlBoard({ dark, params, instrumentType, onParamChange }) {
...
export function GridSeqMixerControls({ dark, params, onParamChange }) {
...
export function PulseWaveControls({ dark, params, onParamChange }) {
  return (
    <div style={{ width: '550px' }}>
      {/* Header */}
      <div style={{
...
export function OscilloscopeVisual({ dark, analyser }) {
...
export function SoundsStudio({ onBack, dark }) {
...
export function PulseWave({ onBack, dark }) {
...
export function GridSeq({ onBack, dark }) {
